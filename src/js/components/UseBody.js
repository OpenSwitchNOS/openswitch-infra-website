            ...
            <Box direction="column">
              ...
              <Box direction="row">
                ...
                <Box direction="column" align="start" responsive={true}>
                  ...
                  <Box pad={{ horizontal: "small" }}>
                    <Link to="documents/user/show_vlog_user_guide"><i className="fa fa-angle-right"></i>Show Vlog</Link>
                  </Box>
                  <Box pad={{ horizontal: "small" }}>
            ...
            <Box direction="column">
              ...
              <Box direction="row">
                ...
                <Box direction="column" align="start" responsive={true}>
                  ...
                  <Box pad={{ horizontal: "small" }}>
                    <Link to="/documents/user/show_vlog_cli"><i className="fa fa-angle-right"></i>Show Vlog</Link>
                  </Box>
                  <Box pad={{ horizontal: "small" }}>
